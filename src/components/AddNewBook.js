    ...
    <>
      ...
      <div className="formContainer w-full px-24 flex flex-col gap-5 mt-5">
        ...
        <form className=" flex justify-between gap-9">
          ...
          <input type="text" name="bookAuthor" placeholder="Author name" className=" w-64 placeholder:pl-4 placeholder:text-gray-400 border-gray-100 border-solid border-2 pl-4" />
